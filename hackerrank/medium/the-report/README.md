...
**Runtime:** N/A  
**Memory:** N/A  
**Submitted:** 2026-09-22T07:58:21.936Z  

```db2
SELECT CASE WHEN g.Grade < 8 THEN 'NULL' ELSE s.Name END, g.Grade, s.Marks FROM students s INNER JOIN grades g ON s.Marks BETWEEN g.Min_Mark AND g.Max_Mark ORDER BY g.Grade DESC, CASE WHEN g.Grade >= 8 THEN s.Name END ASC, CASE WHEN g.Grade < 8 THEN s.Marks END ASC;
